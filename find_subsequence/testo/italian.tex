...
\esempio{
\input{find-subsequence.input0.txt}
}{\input{find-subsequence.output0.txt}}

\esempio{
\input{find-subsequence.input1.txt}
}{\input{find-subsequence.output1.txt}}

\esempio{
\input{find-subsequence.input2.txt}
}{\input{find-subsequence.output2.txt}}
